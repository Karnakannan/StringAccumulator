...
public class StringCalculatorTest {
    ...
    @Test
    public void testDoubleNumbersWithComma() {
     ...
     */
    @Test
    public void testMultipleNumbersWithComma() {
     ...
     */
    @Test
    public void testAnyLengthofDelimiters() {
     ...
     */
    @Test
    public void testLongerlengthDelimiters() {
        assertEquals(6, StringCalculator.add("//*|%%%%%%%%%%%%%%%%\n1*2%%%%%%%%%%3"));
    }
